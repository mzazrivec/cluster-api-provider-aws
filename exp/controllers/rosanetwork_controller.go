...
func (r *RosaNetworkReconciler) Reconcile(ctx context.Context, req ctrl.Request) (res ctrl.Result, reterr error) {
	...
	// TODO
	// 1. if rosaNetwork.ObjectMeta.DeletionTimestamp.IsZero() { return r.reconcileDelete(ctx, rosaNetScope) }
	// 2. otherwise r.reconcileNormal(ctx, rosaScope(ctx, rosaNetScope)
